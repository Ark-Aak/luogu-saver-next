...
import {Settings as SettingsIcon} from '@vicons/ionicons5' // 需要: npm i @vicons/ionicons5
import {uiThemeKey, type UiThemeVars} from '@/styles/themeKeys' // 确保路径正确

// 1. 注入来自 App.vue 的主题 ref
	...
	<n-drawer v-model:show="showDrawer" :width="340" placement="right">
		<n-drawer-content title="主题编辑器">
			...
			>
				...
				<n-form-item label="主色 (Hover)" path="primaryColorHover">
				...
				<h3>您的自定义变量</h3>
				<n-form-item label="自定义卡片标题色 (cardTitleColor)" path="cardTitleColor">
					<n-color-picker v-model:value="uiTheme.cardTitleColor"/>
				</n-form-item>
				<n-form-item label="自定义图标色 (iconColor)" path="iconColor">
					<n-color-picker v-model:value="uiTheme.iconColor"/>
				</n-form-item>
